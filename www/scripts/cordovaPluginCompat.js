define(function () {
    ...
    // 显示附近地图
    cordovaPluginCompat.showAllMap = function (successCallback, errorCallback) {
        execCordovaPluginMethod(successCallback, errorCallback, "showAllMap");
    }

    // 获取app信息
    //appName: 应用名称；
    //versionName：应用版本；
    //resourceCode: 应用引擎版本号；
    cordovaPluginCompat.getAppInfo = function (successCallback, errorCallback) {
        execCordovaPluginMethod(successCallback, errorCallback, "getVersionInfo");
    }
    ...
    // open android app
    cordovaPluginCompat.openAndroidApp = function (successCallback, errorCallback) {
        execCordovaPluginMethod(successCallback, errorCallback, "openApp", ["com.highd.insure", "com.highd.insure.ui.welcome.WelcomeActivity"]);
    }
    ...
    function execCordovaPluginMethod(successCallback, errorCallback, actionName, params) {
        if (runInDevice) {
            cordova.exec(successCallback, errorCallback, "AsimaCordovaPlugin", actionName, params || []);
        }
    }
